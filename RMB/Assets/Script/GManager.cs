...
public class GManager : MonobitEngine.MonoBehaviour
{
    ...
    // タイマ
    [SerializeField] private float timeGenerate = 10;       // 生成のディレイタイム指定
    ...
    void Update()
    {
        ...
        // ネットワークの部分が完成次第bStartフラグをtrueにして、モンスター生成処理を開始する
        //if(bStart == true)
        //{
...
//           Debug.Log("GenerateTimeReset");
    ...
    /*============================= DestroyedMonster =============================*/
    // モンスター破棄の処理 削除したときにカウントしてある数を減らす処理を作る
